...
<div class="card-body">
    ...
    <form action="{{route('admin.makaleler.update',$article->id)}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form group mt-1 mb-1">
            <label>Başlık</label>
            <input type="text" value="{{$article->title}}" name="title" class="form-control mt-1 mb-1" required>
        </div>
        <div class="form group mt-1 mb-1">
            <label>Kategori</label>
            <select name="category" class="form-control" required>
                <option value="">Seçimz Yapınız</option>
        ...
        <div class="form group mt-1 mb-1">
            ...
            <br>
            <img src="{{$article->image}}" style="width:250px; height:150px;" class="img-responsive mt-2 mb-2 rounded shadow  img-thumbnail" alt="">
